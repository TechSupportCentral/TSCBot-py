...
class techinfo(commands.Cog):
    ...
    async def windowsusb(self, ctx):
        ...
        embed.add_field(name="Step 10:", value="Open File Explorer and find your USB flash drive. Right click it and select format. Use NTFS as the filesystem and tick the Quick Format box.\nOnce the format is complete, your drive will be empty and you can use it for your own purposes again.", inline=False)
        await ctx.send(embed=embed)
