...
class techinfo(commands.Cog):
    ...
    @commands.command()
    async def amddrivers(self, ctx: commands.Context):
        await ctx.send(f"https://www.amd.com/en/support")

    @commands.command()
    async def cpuz(self, ctx: commands.Context):
        await ctx.send(f"https://www.cpuid.com/downloads/cpu-z/cpu-z_1.95-en.exe")

    @commands.command()
    async def hwmonitor(self, ctx: commands.Context):
    ...
    @commands.command()
    async def nvidiadrivers(self, ctx: commands.Context):
        await ctx.send(f"https://www.nvidia.com/Download/index.aspx")

    @commands.command()
    async def safemode(self, ctx: commands.Context):
    ...
    @commands.command()
    async def windowsinstall(self, ctx: commands.Context):
    ...
    @commands.command()
    async def linuxusb(self, ctx: commands.Context):
